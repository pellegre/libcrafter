...
| Authentication-parameter byte preservation | RFC 3414 Sections 6 and 7; RFC 7860 Sections 4, 8, and 10 | `crafter/src/protocols/snmp/security.rs` | source-backed preserve planned | Preserve bytes exactly; key storage and verification policy are out of scope. |
| Privacy-parameter byte preservation | RFC 3414 Section 8; RFC 3826 Sections 3 and 5 | `crafter/src/protocols/snmp/security.rs`; `crafter/src/protocols/snmp/v3.rs` | source-backed preserve planned | Preserve DES/AES parameter bytes and encrypted scoped data only. |
