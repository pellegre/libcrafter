...
| Routing Types | Source Route type 0 is deprecated by RFC 5095. Type 2 is Mobile IPv6 from RFC 6275. Type 4 is SRH from RFC 8754. Values 253 and 254 are RFC 3692-style experiments; they must not be emitted as defaults. |
...
- The repo-local `rfc-protocol-spec` discovery for the broad query `IPv6`
  ...
  in the Clew step were manually reviewed against official sources. Future
