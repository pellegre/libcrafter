...
pub const DHCPV4_HTYPE_ETHERNET: u8 = 1;
...
pub const DHCPV4_IPV6_ONLY_PREFERRED_LEN: usize = 4;
...
pub const DHCPV4_OPTION_AUTHENTICATION: u8 = 90;
/// DHCP FORCERENEW_NONCE_CAPABLE option code (RFC 6704 section 4).
pub const DHCPV4_OPTION_FORCERENEW_NONCE_CAPABLE: u8 = 145;
...
pub const DHCPV4_AUTH_HEADER_LEN: usize = 11;
/// Length in octets of the RFC 3118 authentication option Replay Detection
/// field (a 64-bit value).
///
/// Source: RFC 3118 section 2.
pub const DHCPV4_AUTH_REPLAY_DETECTION_LEN: usize = 8;
...
pub const DHCPV4_AUTH_PROTOCOL_CONFIGURATION_TOKEN: u8 = 0;
...
pub const DHCPV4_AUTH_PROTOCOL_DELAYED: u8 = 1;
...
pub const DHCPV4_AUTH_PROTOCOL_RECONFIGURE_KEY: u8 = 3;
...
pub const DHCPV4_DATA_SOURCE_FLAG_REMOTE: u8 = 0x01;
...
pub const DHCPV4_OPTION_TFTP_SERVER_NAME: u8 = 66;
/// DHCP bootfile name option code (RFC 2132 section 9.5).
pub const DHCPV4_OPTION_BOOTFILE_NAME: u8 = 67;
/// DHCP user class option code (RFC 3004).
pub const DHCPV4_OPTION_USER_CLASS: u8 = 77;
/// DHCP client system architecture type option code (RFC 4578).
pub const DHCPV4_OPTION_CLIENT_SYSTEM_ARCHITECTURE: u8 = 93;
/// DHCP client network device interface option code (RFC 4578).
pub const DHCPV4_OPTION_CLIENT_NDI: u8 = 94;
/// DHCP UUID/GUID-based client identifier option code (RFC 4578).
pub const DHCPV4_OPTION_CLIENT_MACHINE_IDENTIFIER: u8 = 97;
/// DHCP V-I Vendor Class option code (RFC 3925).
pub const DHCPV4_OPTION_VI_VENDOR_CLASS: u8 = 124;
/// DHCP V-I Vendor-Specific Information option code (RFC 3925).
pub const DHCPV4_OPTION_VI_VENDOR_SPECIFIC: u8 = 125;
/// DHCP Relay Agent Information option code (RFC 3046).
pub const DHCPV4_OPTION_RELAY_AGENT_INFORMATION: u8 = 82;
/// DHCP TFTP server address option code (RFC 5859).
pub const DHCPV4_OPTION_TFTP_SERVER_ADDRESS: u8 = 150;
/// DHCP PXELINUX magic option code (RFC 5071 / RFC 5494).
pub const DHCPV4_OPTION_PXELINUX_MAGIC: u8 = 208;
/// DHCP PXELINUX configuration file option code (RFC 5071).
pub const DHCPV4_OPTION_PXELINUX_CONFIGFILE: u8 = 209;
/// DHCP PXELINUX path prefix option code (RFC 5071).
pub const DHCPV4_OPTION_PXELINUX_PATHPREFIX: u8 = 210;
/// DHCP PXELINUX reboot time option code (RFC 5071).
pub const DHCPV4_OPTION_PXELINUX_REBOOTTIME: u8 = 211;
...
pub const DHCPV4_CLIENT_ID_TYPE_NONE: u8 = 0;
...
pub const DHCPV4_CLIENT_ID_TYPE_RFC4361: u8 = 255;
