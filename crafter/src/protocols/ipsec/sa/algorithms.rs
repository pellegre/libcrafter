...
//! Parameters" registry as recorded in `docs/ipsec-rfc-manifest.md` (Step 01):
//!
...
mod tests {
    ...
    // --- Encryption transform IDs (IANA / docs/ipsec-rfc-manifest.md) -------
    ...
    // --- Integrity transform IDs (IANA / docs/ipsec-rfc-manifest.md) --------
