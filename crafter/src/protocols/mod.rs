...
pub mod exports {
    ...
    pub use ssdp::{
        ...
        SsdpStartLineParseError, SsdpStatusCode, SsdpStatusLine, SsdpVersion, SSDP_HEADER_BOOTID,
        SSDP_HEADER_CACHE_CONTROL, SSDP_HEADER_CONFIGID, SSDP_HEADER_CPFN, SSDP_HEADER_CPUUID,
        SSDP_HEADER_DATE, SSDP_HEADER_EXT, SSDP_HEADER_HOST, SSDP_HEADER_LOCATION, SSDP_HEADER_MAN,
        ...
        SSDP_HEADER_USN, SSDP_HTTP_VERSION, SSDP_IPV4_MULTICAST, SSDP_IPV4_MULTICAST_HOST,
        SSDP_IPV6_LINK_LOCAL_HOST, SSDP_IPV6_LINK_LOCAL_MULTICAST, SSDP_IPV6_MULTICAST_PATTERN,
        SSDP_IPV6_SITE_LOCAL_HOST, SSDP_IPV6_SITE_LOCAL_MULTICAST, SSDP_MAN_DISCOVER,
        SSDP_METHOD_M_SEARCH, SSDP_METHOD_NOTIFY, SSDP_NTS_ALIVE, SSDP_NTS_BYEBYE, SSDP_NTS_UPDATE,
        SSDP_REASON_OK, SSDP_SERVICE_NAME, SSDP_STATUS_OK, SSDP_ST_ALL, SSDP_TARGET_ROOTDEVICE,
        SSDP_UDP_PORT,
    };
    pub use transport::{
