...
pub mod exports {
    ...
    pub use dhcp::{
        decode_dhcpv4_tftp_server_addresses, option_meta, option_name, option_status,
        scan_dhcpv4_option_segments, dhcpv4_typed_option_value, ClientNetworkDeviceInterface,
        ClientSystemArchitecture, Dhcpv4, Dhcpv4AuthAlgorithm, Dhcpv4AuthProtocol, Dhcpv4Authentication,
        Dhcpv4ClasslessRoute, Dhcpv4ClientIdentifier, Dhcpv4ClientUuid, Dhcpv4DataSource,
        Dhcpv4ForcerenewNonceCapable, Dhcpv4MessageType, Dhcpv4Option, Dhcpv4OptionArea, Dhcpv4OptionCode,
        Dhcpv4OptionFormat, Dhcpv4OptionKind, Dhcpv4OptionMeta, Dhcpv4OptionSegment, Dhcpv4OptionStatus,
        ...
        Dhcpv4VendorSuboption, Dhcpv4VssInfo, OptionOverload, SipServers, BOOTP_REPLY, BOOTP_REQUEST,
