...
pub mod exports {
    ...
    pub use ospf::{
        ospf_autype_name, ospf_options_summary, Ospfv2, OspfBody, OspfChecksumStatus, OSPF_AUTH_LEN,
        OSPF_AUTYPE_CRYPTOGRAPHIC, OSPF_AUTYPE_NULL, OSPF_AUTYPE_SIMPLE, OSPF_HEADER_LEN,
        OSPF_OPTIONS_DC, OSPF_OPTIONS_DN, OSPF_OPTIONS_E, OSPF_OPTIONS_L, OSPF_OPTIONS_MC,
        OSPF_OPTIONS_MT, OSPF_OPTIONS_NP, OSPF_OPTIONS_O, OSPF_TYPE_DATABASE_DESCRIPTION,
        OSPF_TYPE_HELLO, OSPF_TYPE_LINK_STATE_ACK, OSPF_TYPE_LINK_STATE_REQUEST,
        OSPF_TYPE_LINK_STATE_UPDATE, OSPF_VERSION_2,
    };
