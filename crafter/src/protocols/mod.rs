...
pub use ipv6::{
    ipv6_router_alert_value_label, ipv6_routing_type_label, ipv6_routing_type_status, Ipv6,
    ...
    IPPROTO_IPV6_NO_NEXT, IPPROTO_IPV6_ROUTE, IPPROTO_IPV6_SHIM6, IPV6_OPTION_HOME_ADDRESS,
