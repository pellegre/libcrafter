...
pub use dns::{
    decode_dns_name, decode_dns_name_typed, dns_type_name, edns_option_code_name, Dns, DnsName,
    DnsQuestion, DnsRecord, DnsRecordData, DnsTypeBitmaps, EdnsOption, DNS_CLASS_ANY, DNS_CLASS_CH,
    DNS_CLASS_HS, DNS_CLASS_IN, DNS_CLASS_NONE, DNS_EDNS_DEFAULT_UDP_PAYLOAD_SIZE,
