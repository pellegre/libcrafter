...
pub mod exports {
    ...
    pub use ospf::{
        Ospfv2, OspfBody, OspfChecksumStatus, OSPF_AUTH_LEN, OSPF_AUTYPE_CRYPTOGRAPHIC,
        OSPF_AUTYPE_NULL, OSPF_AUTYPE_SIMPLE, OSPF_HEADER_LEN, OSPF_TYPE_DATABASE_DESCRIPTION,
