...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapVersion, OscoreAeadAlgorithm, OscoreContext, OscoreError, OscoreKdfAlgorithm,
        OscoreOption, OscoreProtectParams, OscoreRequestBinding, OscoreUnprotectParams, COAPS_PORT,
