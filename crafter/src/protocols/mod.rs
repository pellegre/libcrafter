...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapContentFormat, CoapEtag, CoapIfMatch, CoapIfNoneMatch, CoapLink, CoapLinkAttribute,
        CoapLinkAttributeValue, CoapLinkFormat, CoapLocationPath, CoapLocationQuery, CoapMaxAge,
        CoapMessageType, CoapNoResponse, CoapObserve, CoapObserveOrdering, CoapOption,
        CoapOptionEncoding, CoapOptionFormat, CoapOptionNumber, CoapOptionOrder, CoapPayloadMarker,
        CoapProxyScheme, CoapProxyUri, CoapRegistryMeta, CoapRegistryStatus, CoapSize1, CoapSize2,
        CoapToken, CoapTokenLength, CoapUriHost, CoapUriPath, CoapUriPort, CoapUriQuery,
        CoapValidation, CoapValidationCategory, CoapValidationIssue, CoapValidationSeverity,
        CoapVersion, COAPS_PORT, COAP_CODE_CLASS_MASK, COAP_CODE_CLASS_SHIFT,
        COAP_CODE_DETAIL_MASK, COAP_CONTENT_FORMAT_LINK_FORMAT, COAP_HEADER_LEN,
        COAP_MAX_TOKEN_LEN, COAP_OPTION_ACCEPT, COAP_OPTION_BLOCK1, COAP_OPTION_BLOCK2,
        COAP_OPTION_CONTENT_FORMAT, COAP_OPTION_ECHO, COAP_OPTION_ETAG, COAP_OPTION_HOP_LIMIT,
        COAP_OPTION_IF_MATCH, COAP_OPTION_IF_NONE_MATCH, COAP_OPTION_LOCATION_PATH,
        COAP_OPTION_LOCATION_QUERY, COAP_OPTION_MAX_AGE, COAP_OPTION_NO_RESPONSE,
        COAP_OPTION_OBSERVE, COAP_OPTION_OSCORE, COAP_OPTION_PROXY_SCHEME, COAP_OPTION_PROXY_URI,
        COAP_OPTION_Q_BLOCK1, COAP_OPTION_Q_BLOCK2, COAP_OPTION_REQUEST_TAG, COAP_OPTION_SIZE1,
        COAP_OPTION_SIZE2, COAP_OPTION_URI_HOST, COAP_OPTION_URI_PATH, COAP_OPTION_URI_PORT,
        COAP_OPTION_URI_QUERY, COAP_PAYLOAD_MARKER, COAP_PORT, COAP_TKL_MASK, COAP_TYPE_MASK,
        COAP_TYPE_SHIFT, COAP_VERSION_1, COAP_VERSION_MASK, COAP_VERSION_SHIFT,
    };
