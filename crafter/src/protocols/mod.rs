...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapMessageType, CoapObserve, CoapObserveOrdering, CoapOption, CoapOptionEncoding,
        CoapOptionFormat, CoapOptionNumber, CoapOptionOrder, CoapPayloadMarker, CoapProxyScheme,
        CoapProxyUri, CoapRegistryMeta, CoapRegistryStatus, CoapSize1, CoapSize2, CoapToken,
