...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapContentFormat, CoapEcho, CoapEtag, CoapGroupMatch, CoapGroupMetadata, CoapHopLimit,
        CoapHopLimitExhausted, CoapIfMatch, CoapIfNoneMatch, CoapLink, CoapLinkAttribute,
        ...
        CoapProxyScheme, CoapProxyUri, CoapRegistryMeta, CoapRegistryStatus, CoapRequestTag,
