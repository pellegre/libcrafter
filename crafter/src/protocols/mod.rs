...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapMaxAge, CoapMessageType, CoapOption, CoapOptionEncoding, CoapOptionFormat,
        ...
        CoapUriQuery, CoapVersion, COAPS_PORT, COAP_CODE_CLASS_MASK, COAP_CODE_CLASS_SHIFT,
        COAP_CODE_DETAIL_MASK, COAP_HEADER_LEN, COAP_MAX_TOKEN_LEN, COAP_OPTION_ACCEPT,
