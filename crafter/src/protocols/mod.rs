...
pub use dns::{
    ...
    DnsQuestion, DnsRecord, DnsRecordData, EdnsOption, DNS_CLASS_ANY, DNS_CLASS_CH, DNS_CLASS_HS,
    DNS_CLASS_IN, DNS_CLASS_NONE, DNS_EDNS_DEFAULT_UDP_PAYLOAD_SIZE, DNS_EDNS_FLAG_DO,
