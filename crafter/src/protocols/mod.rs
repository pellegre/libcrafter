...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapIfMatch, CoapIfNoneMatch, CoapLocationPath, CoapLocationQuery, CoapMaxAge,
        CoapMessageType, CoapOption, CoapOptionEncoding, CoapOptionFormat, CoapOptionNumber,
        CoapOptionOrder, CoapPayloadMarker, CoapProxyScheme, CoapProxyUri, CoapRegistryMeta,
        CoapRegistryStatus, CoapSize1, CoapSize2, CoapToken, CoapTokenLength, CoapUriHost,
        CoapUriPath, CoapUriPort, CoapUriQuery, CoapValidation, CoapValidationCategory,
        CoapValidationIssue, CoapValidationSeverity, CoapVersion, COAPS_PORT, COAP_CODE_CLASS_MASK,
