...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapRegistryStatus, CoapReliable, CoapReliableLength, CoapRequestTag, CoapSize1, CoapSize2,
        CoapToken, CoapTokenLength, CoapTokenLengthEncoding, CoapUriHost, CoapUriPath, CoapUriPort,
        CoapUriQuery, CoapValidation, CoapValidationCategory, CoapValidationIssue,
        CoapValidationSeverity, CoapVersion, COAPS_PORT, COAP_ALL_NODES_IPV4_MULTICAST,
