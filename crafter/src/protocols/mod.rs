...
pub mod exports {
    ...
    pub use snmp::{
        ...
        SnmpSecurityModel, SnmpSecurityModelMeta, SnmpSecurityModelStatus, SnmpV1TrapPdu,
        SnmpV3Flags, SnmpV3GlobalData, SnmpV3Message, SnmpVarBind, SnmpVarBindList, SnmpVersion,
