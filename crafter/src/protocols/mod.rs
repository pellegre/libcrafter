...
pub mod exports {
    ...
    pub use quic::{
        Quic, QuicConnectionId, QuicFrame, QuicPacket, QuicPacketNumber, QuicRetryBuilder,
        QuicRetryPacket, QuicTransportParameter, QuicVarInt, QuicVersionNegotiationBuilder,
