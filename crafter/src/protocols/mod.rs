...
pub use icmp::{
    ...
    NdpOption, NdpOptions, NeighborAdvertisement, NeighborSolicitation, Prf, Redirect,
    RouterAdvertisement, RouterSolicitation, ICMPV6_DESTINATION_UNREACHABLE, ICMPV6_ECHO_REPLY,
    ICMPV6_ECHO_REQUEST, ICMPV6_EXTENDED_ECHO_REPLY, ICMPV6_EXTENDED_ECHO_REQUEST,
