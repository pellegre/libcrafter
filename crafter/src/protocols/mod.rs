...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapCode, CoapEtag, CoapIfMatch, CoapIfNoneMatch, CoapMessageType, CoapOption,
        CoapOptionEncoding, CoapOptionFormat, CoapOptionNumber, CoapOptionOrder, CoapPayloadMarker,
        CoapRegistryMeta, CoapRegistryStatus, CoapToken, CoapTokenLength, CoapUriHost, CoapUriPath,
        CoapUriPort, CoapUriQuery, CoapVersion, COAPS_PORT, COAP_CODE_CLASS_MASK,
