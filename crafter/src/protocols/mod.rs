...
pub mod exports {
    ...
    pub use link::{
        ...
        Dot15d4, Dot15d4AddrMode, Dot15d4FrameType, Dot15d4Radio, Dot1Q, Ethernet, LinuxSll,
        LlcSnap, NullByteOrder, NullLoopback, Radiotap, RadiotapChannel, RadiotapTxFlags, Vlan,
        ZigbeeAps, ZigbeeNwk, ARP_HRD_ATM, ARP_HRD_ETHERNET, ARP_HRD_FIBRE_CHANNEL,
