...
pub mod exports {
    ...
    pub use ssdp::{
        ...
        SsdpHeaderValue, SsdpHeaders, SsdpLocation, SsdpLocationField, SsdpLocationParseError,
        SsdpMessage, SsdpMethod, SsdpMethodParseError, SsdpParseError, SsdpParseErrorKind,
        SsdpParseField, SsdpReasonPhrase, SsdpRequestLine, SsdpRequestTarget, SsdpStartLine,
        SsdpStartLineField, SsdpStartLineParseError, SsdpStatusCode, SsdpStatusLine, SsdpTarget,
        SsdpUsn, SsdpVersion, SSDP_HEADER_BOOTID, SSDP_HEADER_CACHE_CONTROL, SSDP_HEADER_CONFIGID,
        SSDP_HEADER_CPFN, SSDP_HEADER_CPUUID, SSDP_HEADER_DATE, SSDP_HEADER_EXT, SSDP_HEADER_HOST,
