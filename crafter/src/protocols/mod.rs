...
pub mod exports {
    ...
    pub use quic::{
        grease_transport_parameter_id, is_grease_transport_parameter_id, Quic, QuicAckEcnCounts,
        ...
        QuicHandshakeDoneFrame, QuicInitialBuilder, QuicIntegerTransportParameter,
