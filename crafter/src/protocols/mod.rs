...
pub mod exports {
    ...
    pub use ssdp::{
        ...
        SsdpTarget, SsdpUsn, SsdpVersion, SSDP_HEADER_BOOTID, SSDP_HEADER_CACHE_CONTROL,
        SSDP_HEADER_CONFIGID, SSDP_HEADER_CPFN, SSDP_HEADER_CPUUID, SSDP_HEADER_DATE,
        SSDP_HEADER_EXT, SSDP_HEADER_HOST, SSDP_HEADER_LOCATION, SSDP_HEADER_MAN, SSDP_HEADER_MX,
        SSDP_HEADER_NEXTBOOTID, SSDP_HEADER_NLS_SUFFIX, SSDP_HEADER_NT, SSDP_HEADER_NTS,
        SSDP_HEADER_OPT, SSDP_HEADER_SEARCHPORT, SSDP_HEADER_SECURELOCATION, SSDP_HEADER_SERVER,
        SSDP_HEADER_ST, SSDP_HEADER_TCPPORT, SSDP_HEADER_USER_AGENT, SSDP_HEADER_USN,
        SSDP_HTTP_VERSION, SSDP_IPV4_MULTICAST, SSDP_IPV4_MULTICAST_ADDR, SSDP_IPV4_MULTICAST_HOST,
