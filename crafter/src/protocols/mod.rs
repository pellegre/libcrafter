...
pub mod exports {
    ...
    pub use quic::{
        ...
        quic_chacha20_header_protection_mask, quic_header_protection_mask, quic_initial_salt, Quic,
        ...
        QuicCryptoFrame, QuicDataBlockedFrame, QuicFrame, QuicFrameKind, QuicHandshakeBuilder,
        ...
        QUIC_HEADER_PROTECTION_SAMPLE_LEN, QUIC_INITIAL_AES_128_KEY_LEN, QUIC_INITIAL_HP_KEY_LEN,
