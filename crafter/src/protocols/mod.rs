...
pub mod exports {
    ...
    pub use dhcp::{
        decode_dhcpv4_tftp_server_addresses, dhcpv4_typed_option_value, option_meta, option_name,
        option_status, scan_dhcpv4_option_segments, ClientNetworkDeviceInterface,
        ClientSystemArchitecture, Dhcpv4, Dhcpv4AuthAlgorithm, Dhcpv4AuthProtocol,
        Dhcpv4Authentication, Dhcpv4ClasslessRoute, Dhcpv4ClientIdentifier, Dhcpv4ClientUuid,
        Dhcpv4DataSource, Dhcpv4ForcerenewNonceCapable, Dhcpv4MessageType, Dhcpv4Option,
        Dhcpv4OptionArea, Dhcpv4OptionCode, Dhcpv4OptionFormat, Dhcpv4OptionKind, Dhcpv4OptionMeta,
        Dhcpv4OptionSegment, Dhcpv4OptionStatus, Dhcpv4OptionValue, Dhcpv4RelayAgentInfo,
        Dhcpv4RelaySuboption, Dhcpv4RelayVendorSpecific, Dhcpv4ReplayDetectionMethod, Dhcpv4State,
        Dhcpv4StaticRoute, Dhcpv4StatusCode, Dhcpv4StatusCodeOption, Dhcpv4UserClass,
        Dhcpv4VendorClassData, Dhcpv4VendorIdentifyingOption, Dhcpv4VendorSuboption, Dhcpv4VssInfo,
        OptionOverload, SipServers, BOOTP_REPLY, BOOTP_REQUEST, DHCPV4_ACK,
        ...
        DHCPV4_FORCERENEW_NONCE_TYPE_HMAC_MD5, DHCPV4_FORCERENEW_NONCE_TYPE_NONCE,
        DHCPV4_HTYPE_ETHERNET, DHCPV4_INFORM, DHCPV4_MAGIC_COOKIE, DHCPV4_MAGIC_COOKIE_LEN,
        DHCPV4_MIN_LEN, DHCPV4_NAK, DHCPV4_OFFER, DHCPV4_OPTION_AUTHENTICATION,
        DHCPV4_OPTION_BOOTFILE_NAME, DHCPV4_OPTION_BROADCAST_ADDRESS,
