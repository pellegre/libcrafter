...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapContentFormat, CoapEcho, CoapEtag, CoapHopLimit, CoapHopLimitExhausted, CoapIfMatch,
        ...
        CoapRegistryMeta, CoapRegistryStatus, CoapRequestTag, CoapSize1, CoapSize2, CoapToken,
        CoapTokenLength, CoapTokenLengthEncoding, CoapUriHost, CoapUriPath, CoapUriPort,
        CoapUriQuery, CoapValidation, CoapValidationCategory, CoapValidationIssue,
        CoapValidationSeverity, CoapVersion, COAPS_PORT, COAP_CODE_CLASS_MASK,
        COAP_CODE_CLASS_SHIFT, COAP_CODE_DETAIL_MASK, COAP_CONTENT_FORMAT_LINK_FORMAT,
