...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapCode, CoapContentFormat, CoapEtag, CoapIfMatch, CoapIfNoneMatch, CoapLink,
        CoapLinkAttribute, CoapLinkAttributeValue, CoapLinkFormat, CoapLocationPath,
        CoapLocationQuery, CoapMaxAge, CoapMessageType, CoapObserve, CoapObserveOrdering,
        CoapOption, CoapOptionEncoding, CoapOptionFormat, CoapOptionNumber, CoapOptionOrder,
        CoapPayloadMarker, CoapProxyScheme, CoapProxyUri, CoapRegistryMeta, CoapRegistryStatus,
        CoapSize1, CoapSize2, CoapToken, CoapTokenLength, CoapUriHost, CoapUriPath, CoapUriPort,
