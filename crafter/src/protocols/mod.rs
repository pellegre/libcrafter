...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapProxyScheme, CoapProxyUri, CoapRegistryMeta, CoapRegistryStatus, CoapReliable,
        CoapReliableLength, CoapRequestTag, CoapSize1, CoapSize2, CoapToken, CoapTokenLength,
        ...
        CoapVersion, COAPS_PORT, COAP_ALL_NODES_IPV4_MULTICAST,
