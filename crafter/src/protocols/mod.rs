...
pub mod exports {
    ...
    pub use coap::{
        ...
        coap_signaling_option_meta, decode_coap, decode_coap_reliable, validate_coap_proxy_options,
        Coap, CoapAccept, CoapBlock, CoapBlockKind, CoapBlockTransport, CoapBlockValidation,
        CoapCode, CoapContentFormat, CoapEcho, CoapEtag, CoapGroupMatch, CoapGroupMetadata,
        CoapHopLimit, CoapHopLimitExhausted, CoapIfMatch, CoapIfNoneMatch, CoapLink,
        CoapLinkAttribute, CoapLinkAttributeValue, CoapLinkFormat, CoapLocationPath,
        CoapLocationQuery, CoapMaxAge, CoapMessageType, CoapNoResponse, CoapObserve,
        CoapObserveOrdering, CoapOption, CoapOptionEncoding, CoapOptionFormat, CoapOptionNumber,
        CoapOptionOrder, CoapPayloadMarker, CoapProxyScheme, CoapProxyUri, CoapRegistryMeta,
        CoapRegistryStatus, CoapReliable, CoapReliableLength, CoapRequestTag, CoapSignalingOption,
        CoapSize1, CoapSize2, CoapToken, CoapTokenLength, CoapTokenLengthEncoding, CoapUriHost,
        CoapUriPath, CoapUriPort, CoapUriQuery, CoapValidation, CoapValidationCategory,
        CoapValidationIssue, CoapValidationSeverity, CoapVersion, OscoreAeadAlgorithm,
        OscoreContext, OscoreError, OscoreKdfAlgorithm, OscoreOption, COAPS_PORT,
