...
pub mod exports {
    ...
    pub use coap::{
        ...
        coap_response_udp, coap_signaling_code_meta, coap_signaling_option_meta, decode_coap,
        validate_coap_proxy_options, Coap, CoapAccept, CoapCode, CoapContentFormat, CoapEtag,
        CoapIfMatch, CoapIfNoneMatch, CoapLink, CoapLinkAttribute, CoapLinkAttributeValue,
        CoapLinkFormat, CoapLocationPath, CoapLocationQuery, CoapMaxAge, CoapMessageType,
