...
pub mod exports {
    ...
    pub use coap::{
        ...
        CoapAccept, CoapCode, CoapContentFormat, CoapEtag, CoapIfMatch, CoapIfNoneMatch,
        CoapLocationPath, CoapLocationQuery, CoapMaxAge, CoapMessageType, CoapOption,
        ...
        CoapUriHost, CoapUriPath, CoapUriPort, CoapUriQuery, CoapVersion, COAPS_PORT,
        COAP_CODE_CLASS_MASK, COAP_CODE_CLASS_SHIFT, COAP_CODE_DETAIL_MASK, COAP_HEADER_LEN,
