...
mod tcp {
    ...
    fn tcp_flag_public_aliases() {
        ...
        // resolve to the same value. See docs/guide/tcp.md.
    ...
    fn tcp_accurate_ecn_flag_aliases_ns() {
        ...
        // same value. See docs/guide/tcp.md.
        assert_eq!(TCP_FLAG_AE, TCP_FLAG_NS);
...
mod inspection_fields {
    ...
    fn tcp_inspection_fields_include_options_and_header_len() {
        ...
        // inspection. See docs/guide/tcp.md for the option/flag names.
...
mod edo_compatibility {
    ...
    // experimental ExID support (step 17). See docs/guide/tcp.md and
    // docs/guide/tcp.md. This test only exercises the existing
