...
pub use protocols::{
    ...
    Ipv4Option, Ipv4OptionIter, Ipv4Protocol, Ipv4RouteOptionKind, Ipv6, Ipv6FragmentHeader,
    Ipv6MobileRoutingHeader, Ipv6RoutingHeader, Ipv6SegmentRoutingHeader, LinuxSll, Mldv2Query,
    Mldv2Report, MulticastAddressRecord, MulticastListenerMessage, MulticastRecordType, NdpOption,
    NdpOptions, NeighborAdvertisement, NeighborSolicitation, NodeInformation, NullByteOrder,
    NullLoopback, OptionOverload, Pref64Plc, Prf, Redirect, RouterAdvertisement,
...
pub mod core {
    ...
    pub use crate::{
        ...
        IntoPacket, Ipv4, Ipv4Option, Ipv4OptionIter, Ipv4Protocol, Ipv4ProtocolBindingContext,
        ...
        LayerContext, LinkType, LinuxSll, MacAddr, Mldv2Query, Mldv2Report, MulticastAddressRecord,
