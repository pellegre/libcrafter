...
pub mod core {
    ...
    pub use crate::{
        ...
        Ipv6SegmentRoutingHeader, Layer, LayerContext, LinkType, LinuxSll, MacAddr, Mldv2Query,
        Mldv2Report, MulticastAddressRecord, MulticastListenerMessage, MulticastRecordType,
        NdpOption, NdpOptions, NeighborAdvertisement, NeighborSolicitation, NetworkLayer,
        NodeInformation, NullByteOrder, NullLoopback, OptionOverload, Packet, Pref64Plc, Prf,
        ProtocolRegistry, Raw, Redirect, Result, RouterAdvertisement, RouterSolicitation,
