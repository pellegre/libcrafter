...
pub use protocols::{
    decode_dns_name, Arp, ArpOperation, Dhcp, DhcpMessageType, DhcpOption, Dns, DnsQuestion,
...
pub mod core {
    ...
    pub use crate::{
        decode_dns_name, hexdump, Arp, ArpOperation, CompiledPacket, CrafterError, Dhcp,
        DhcpMessageType, DhcpOption, Dns, DnsQuestion, DnsRecord, DnsRecordData, Dot1Q, Ethernet,
        ...
        DHCP_REQUEST, DHCP_SERVER_PORT, DNS_CLASS_IN, DNS_FLAG_AUTHENTIC_DATA,
