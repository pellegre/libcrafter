...
pub use protocols::{
    ...
    udp_option_kind_is_unsafe, udp_option_kind_is_unsupported, Ah, Arp, ArpOperation,
    AsPathSegment, Bgp, BgpAttrValue, BgpCapability, BgpKeepalive, BgpNotification, BgpOpen,
    BgpPathAttribute, BgpPrefix, BgpRouteRefresh, BgpUpdate, ClientNetworkDeviceInterface,
    ...
    ARP_PRO_IPV4, BGP_AS_SEGMENT_SEQUENCE, BGP_AS_SEGMENT_SET, BGP_ORIGIN_EGP, BGP_ORIGIN_IGP,
    BGP_ORIGIN_INCOMPLETE, BOOTP_REPLY, BOOTP_REQUEST, DHCP_ACK, DHCP_AUTH_ALGORITHM_HMAC_MD5,
...
pub mod core {
    ...
    pub use crate::{
        ...
        udp_option_kind_is_unsupported, Ah, Arp, ArpOperation, AsPathSegment, Bgp, BgpAttrValue,
        BgpCapability, BgpKeepalive, BgpNotification, BgpOpen, BgpPathAttribute, BgpPrefix,
        BgpRouteRefresh, BgpUpdate, ClientNetworkDeviceInterface, ClientSystemArchitecture,
        CompiledPacket, CrafterError, Dhcp, DhcpAuthAlgorithm, DhcpAuthProtocol,
        ...
        ARP_OP_RESERVED, ARP_OP_RESERVED_MAX, ARP_PRO_IPV4, BGP_AS_SEGMENT_SEQUENCE,
        BGP_AS_SEGMENT_SET, BGP_ORIGIN_EGP, BGP_ORIGIN_IGP, BGP_ORIGIN_INCOMPLETE, BOOTP_REPLY,
