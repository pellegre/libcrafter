...
pub use protocols::{
    ...
    DhcpClasslessRoute, DhcpClientIdentifier, DhcpClientUuid, DhcpForcerenewNonceCapable,
    ...
    DhcpRelayAgentInfo, DhcpRelaySuboption, DhcpRelayVendorSpecific, DhcpReplayDetectionMethod,
    DhcpStaticRoute, DhcpUserClass, DhcpVendorClassData, DhcpVendorIdentifyingOption,
    ...
    TcpSackBlock, Udp, Vlan, BOOTP_REPLY, BOOTP_REQUEST, DHCP_ACK, DHCP_AUTH_ALGORITHM_HMAC_MD5,
...
pub mod core {
    ...
    pub use crate::{
        ...
        DhcpClientIdentifier, DhcpClientUuid, DhcpForcerenewNonceCapable, DhcpMalformed,
        DhcpMessageType, DhcpOption, DhcpOptionArea, DhcpOptionCode, DhcpOptionFormat,
        DhcpOptionKind, DhcpOptionMeta, DhcpOptionSegment, DhcpOptionStatus, DhcpOptionValue,
        DhcpRelayAgentInfo, DhcpRelaySuboption, DhcpRelayVendorSpecific, DhcpReplayDetectionMethod,
        DhcpStaticRoute, DhcpUserClass, DhcpVendorClassData, DhcpVendorIdentifyingOption,
