...
pub use protocols::{
    ...
    Ipv6SegmentRoutingHeader, LinuxSll, NullByteOrder, NullLoopback, Tcp, TcpExtendedDataOffset,
    TcpOption, TcpOptionIter, TcpSackBlock, Udp, Vlan, BOOTP_REPLY, BOOTP_REQUEST, DHCP_ACK,
    ...
    DHCP_REQUEST, DHCP_SERVER_PORT, DNS_CLASS_IN, DNS_FLAG_AUTHENTIC_DATA, DNS_FLAG_AUTHORITATIVE,
...
pub mod core {
    ...
    pub use crate::{
        ...
        Packet, ProtocolRegistry, Raw, Result, Tcp, TcpBindingContext, TcpExtendedDataOffset,
        TcpOption, TcpOptionIter, TcpSackBlock, TransportChecksumContext, Udp, UdpBindingContext,
        Vlan, BOOTP_REPLY, BOOTP_REQUEST, DHCP_ACK, DHCP_CLIENT_PORT, DHCP_DECLINE, DHCP_DISCOVER,
        ...
        DHCP_OPTION_SUBNET_MASK, DHCP_RELEASE, DHCP_REQUEST, DHCP_SERVER_PORT, DNS_CLASS_IN,
