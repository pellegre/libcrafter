...
pub use protocols::{
    ...
    Dot11ReassociationRequestFixedFields, Dot11SequenceControl, Dot1Q, Dscp, Eapol, Ecn,
    EdnsOption, Ethernet, IcmpExtension, IcmpExtensionInterfaceId, IcmpExtensionInterfaceInfo,
...
pub mod core {
    ...
    pub use crate::{
        ...
        Dot11FrameType, Dot11ManagementFixedFields, Dot11ManagementSubtype,
