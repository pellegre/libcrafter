...
pub use protocols::{
    ...
    IcmpExtensionObject, IcmpKind, IcmpLayer, IcmpQuotedIpv4, Icmpv6, IpProtocol, Ipv4,
...
pub mod core {
    ...
    pub use crate::{
        ...
        IcmpExtensionObject, IcmpKind, IcmpLayer, IcmpQuotedIpv4, Icmpv6, IntoPacket, IpProtocol,
        Ipv4, Ipv4Option, Ipv4OptionIter, Ipv4ProtocolBindingContext, Ipv4RouteOptionKind, Ipv6,
