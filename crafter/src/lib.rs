...
pub use protocols::{
    ...
    ipv6_router_alert_value_label, ndp_option_type_is_known, ndp_option_type_name,
    ...
    IPV4_OPTION_TIMESTAMP, IPV4_OPTION_TRACEROUTE, IPV6_OPTION_JUMBO_PAYLOAD, IPV6_OPTION_PAD1,
    IPV6_OPTION_PADN, IPV6_OPTION_ROUTER_ALERT, IPV6_ROUTER_ALERT_ACTIVE_NETWORKS,
    IPV6_ROUTER_ALERT_MLD, IPV6_ROUTER_ALERT_MPLS_OAM, IPV6_ROUTER_ALERT_RESERVED,
    IPV6_ROUTER_ALERT_RSVP, IPV6_ROUTING_TYPE_MOBILE,
...
pub mod core {
    ...
    pub use crate::{
        ...
        IPV6_ROUTER_ALERT_RESERVED, IPV6_ROUTER_ALERT_RSVP, IPV6_ROUTING_TYPE_MOBILE,
