...
pub use protocols::{
    decode_dns_name, option_meta, option_name, option_status, scan_dhcp_option_segments, Arp,
    ArpOperation, Dhcp, DhcpMalformed, DhcpMessageType, DhcpOption, DhcpOptionArea, DhcpOptionCode,
    DhcpOptionMeta, DhcpOptionSegment, DhcpOptionStatus, DhcpOptionValue, Dns, DnsQuestion,
    DnsRecord, DnsRecordData, Dot1Q, Ethernet, Icmp, IcmpExtension, IcmpExtensionMpls,
    ...
    Ipv6SegmentRoutingHeader, LinuxSll, NullByteOrder, NullLoopback, OptionOverload, Tcp,
    TcpExtendedDataOffset, TcpOption, TcpOptionIter, TcpSackBlock, Udp, Vlan, BOOTP_REPLY,
    BOOTP_REQUEST, DHCP_ACK, DHCP_CLIENT_PORT, DHCP_DECLINE, DHCP_DISCOVER, DHCP_HTYPE_ETHERNET,
    ...
    DHCP_OPTION_PRIVATE_USE_START, DHCP_OPTION_REBINDING_TIME, DHCP_OPTION_RENEWAL_TIME,
    ...
    DHCP_RELEASE, DHCP_REQUEST, DHCP_SERVER_PORT, DNS_CLASS_IN, DNS_FLAG_AUTHENTIC_DATA,
    ...
    DNS_PORT, DNS_TYPE_A, DNS_TYPE_AAAA, DNS_TYPE_CNAME, DNS_TYPE_MX, DNS_TYPE_NS, DNS_TYPE_PTR,
    DNS_TYPE_TXT, ETHERTYPE_ARP, ETHERTYPE_IPV4, ETHERTYPE_IPV6, ETHERTYPE_VLAN,
    ...
    ICMP_PARAMETER_PROBLEM, ICMP_REDIRECT, ICMP_SOURCE_QUENCH, ICMP_TIME_EXCEEDED, IPPROTO_ICMP,
    IPPROTO_ICMPV6, IPPROTO_IPV6, IPPROTO_IPV6_DSTOPTS, IPPROTO_IPV6_FRAGMENT,
...
pub mod core {
    ...
    pub use crate::{
        ...
        scan_dhcp_option_segments, Arp, ArpOperation, CompiledPacket, CrafterError, Dhcp,
        DhcpMalformed, DhcpMessageType, DhcpOption, DhcpOptionArea, DhcpOptionCode, DhcpOptionMeta,
        DhcpOptionSegment, DhcpOptionStatus, DhcpOptionValue, Dns, DnsQuestion, DnsRecord,
        DnsRecordData, Dot1Q, Ethernet, EthertypeBindingContext, Field, FieldState, Icmp,
        IcmpExtension, IcmpExtensionMpls, IcmpExtensionObject, IcmpKind, IcmpLayer, Icmpv6,
        ...
        OptionOverload, Packet, ProtocolRegistry, Raw, Result, Tcp, TcpBindingContext,
        TcpExtendedDataOffset, TcpOption, TcpOptionIter, TcpSackBlock, TransportChecksumContext,
        Udp, UdpBindingContext, Vlan, BOOTP_REPLY, BOOTP_REQUEST, DHCP_ACK, DHCP_CLIENT_PORT,
        ...
        DHCP_OPTION_PARAMETER_REQUEST_LIST, DHCP_OPTION_PRIVATE_USE_END,
        DHCP_OPTION_PRIVATE_USE_START, DHCP_OPTION_REBINDING_TIME, DHCP_OPTION_RENEWAL_TIME,
        DHCP_OPTION_REQUESTED_IP_ADDRESS, DHCP_OPTION_ROUTER, DHCP_OPTION_SERVER_IDENTIFIER,
        DHCP_OPTION_SUBNET_MASK, DHCP_OVERLOAD_BOTH, DHCP_OVERLOAD_FILE, DHCP_OVERLOAD_SNAME,
        DHCP_RELEASE, DHCP_REQUEST, DHCP_SERVER_PORT, DNS_CLASS_IN, DNS_FLAG_AUTHENTIC_DATA,
        ...
        DNS_HEADER_LEN, DNS_PORT, DNS_TYPE_A, DNS_TYPE_AAAA, DNS_TYPE_CNAME, DNS_TYPE_MX,
        DNS_TYPE_NS, DNS_TYPE_PTR, DNS_TYPE_TXT, ETHERTYPE_ARP, ETHERTYPE_IPV4, ETHERTYPE_IPV6,
        ETHERTYPE_VLAN, ICMPV6_DESTINATION_UNREACHABLE, ICMPV6_ECHO_REPLY, ICMPV6_ECHO_REQUEST,
        ICMPV6_PACKET_TOO_BIG, ICMPV6_PARAMETER_PROBLEM, ICMPV6_TIME_EXCEEDED,
