...
pub use protocols::{
    ...
    Ipv6RoutingHeader, Ipv6SegmentRoutingHeader, LinuxSll, MulticastListenerMessage, NdpOption,
    NdpOptions, NeighborAdvertisement, NeighborSolicitation, NullByteOrder, NullLoopback,
...
pub mod core {
    ...
    pub use crate::{
        ...
        LayerContext, LinkType, LinuxSll, MacAddr, MulticastListenerMessage, NdpOption, NdpOptions,
