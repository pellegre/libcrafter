...
pub use protocols::{
    ...
    IcmpExtensionMpls, IcmpExtensionObject, IcmpKind, IcmpLayer, IcmpQuotedIpv4, IcmpTimestamp,
    Icmpv6, IpProtocol, Ipv4,
    ...
    ICMP_EXTENDED_ECHO_REQUEST, ICMP_EXTENSION_CLASS_MPLS, ICMP_EXTENSION_CTYPE_MPLS_INCOMING,
    ICMP_INFORMATION_REPLY, ICMP_INFORMATION_REQUEST, ICMP_IPV6_I_AM_HERE, ICMP_IPV6_WHERE_ARE_YOU,
    ...
    ICMP_SEAMOBY_EXPERIMENTAL, ICMP_SKIP, ICMP_SOURCE_QUENCH, ICMP_TIMESTAMP, ICMP_TIMESTAMP_REPLY,
    ICMP_TIME_EXCEEDED, ICMP_TRACEROUTE, IPPROTO_ICMP, IPPROTO_ICMPV6, IPPROTO_IPV6,
...
pub mod core {
    ...
    pub use crate::{
        ...
        IcmpExtensionMpls, IcmpExtensionObject, IcmpKind, IcmpLayer, IcmpQuotedIpv4,
        IcmpTimestamp, Icmpv6, IntoPacket, IpProtocol, Ipv4, Ipv4Option, Ipv4OptionIter,
        ...
        ICMP_EXTENSION_CLASS_MPLS, ICMP_EXTENSION_CTYPE_MPLS_INCOMING, ICMP_INFORMATION_REPLY,
        ICMP_INFORMATION_REQUEST, ICMP_IPV6_I_AM_HERE, ICMP_IPV6_WHERE_ARE_YOU,
        ...
        ICMP_ROUTER_ADVERTISEMENT, ICMP_ROUTER_SOLICITATION, ICMP_SEAMOBY_EXPERIMENTAL, ICMP_SKIP,
        ICMP_SOURCE_QUENCH, ICMP_TIMESTAMP, ICMP_TIMESTAMP_REPLY, ICMP_TIME_EXCEEDED,
        ICMP_TRACEROUTE, IPPROTO_ICMP, IPPROTO_ICMPV6, IPPROTO_IPV6, IPPROTO_IPV6_DSTOPTS,
