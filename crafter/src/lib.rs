...
pub mod core {
    ...
    pub use crate::{
        ...
        NeighborAdvertisement, NeighborSolicitation, NetworkLayer, NullByteOrder, NullLoopback,
        OptionOverload, Packet, Pref64Plc, Prf, ProtocolRegistry, Raw, Redirect, Result,
