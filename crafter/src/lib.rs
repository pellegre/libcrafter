...
pub use protocols::{
    ...
    DHCP_OPTION_PRIVATE_USE_START, DHCP_OPTION_REBINDING_TIME, DHCP_OPTION_RELAY_AGENT_INFORMATION,
    ...
    DHCP_OVERLOAD_SNAME, DHCP_RELAY_FLAG_UNICAST, DHCP_RELAY_SUBOPTION_ACCESS_NETWORK_NAME,
...
pub mod core {
    ...
    pub use crate::{
        ...
        DhcpOptionSegment, DhcpOptionStatus, DhcpOptionValue, DhcpRelayAgentInfo,
        DhcpRelaySuboption, DhcpRelayVendorSpecific, DhcpStaticRoute, DhcpUserClass,
        DhcpVendorClassData, DhcpVendorIdentifyingOption, DhcpVendorSuboption, DhcpVssInfo, Dns,
