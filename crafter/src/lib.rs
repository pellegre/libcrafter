...
pub use protocols::{
    ...
    Ipv4Option, Ipv4OptionIter, Ipv4OptionKind, Ipv4Protocol, Ipv4RouteOptionKind, Ipv6,
    Ipv6FragmentHeader, Ipv6MobileRoutingHeader, Ipv6RoutingHeader, Ipv6SegmentRoutingHeader,
    LinuxSll, Mldv2Query, Mldv2Report, MulticastAddressRecord, MulticastListenerMessage,
    MulticastRecordType, NdpOption, NdpOptions, NeighborAdvertisement, NeighborSolicitation,
    NodeInformation, NullByteOrder, NullLoopback, OptionOverload, Pref64Plc, Prf, Redirect,
...
pub mod core {
    ...
    pub use crate::{
        ...
        IntoPacket, Ipv4, Ipv4Option, Ipv4OptionIter, Ipv4OptionKind, Ipv4Protocol,
        ...
        IPV4_OPTION_ROUTER_ALERT, IPV4_OPTION_STRICT_SOURCE_ROUTE, IPV4_OPTION_TIMESTAMP,
        IPV4_OPTION_TRACEROUTE, IPV6_ROUTING_TYPE_MOBILE, IPV6_ROUTING_TYPE_SEGMENT,
        IPV6_SEGMENT_POLICY_EGRESS, IPV6_SEGMENT_POLICY_INGRESS,
