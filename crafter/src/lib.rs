...
pub use protocols::{
    ...
    option_status, scan_dhcp_option_segments, typed_option_value, udp_option_kind_class,
    udp_option_kind_is_unsafe, udp_option_kind_is_unsupported, Arp, ArpOperation,
    ClientNetworkDeviceInterface, ClientSystemArchitecture, Dhcp, DhcpAuthAlgorithm,
    ...
    DhcpVendorSuboption, DhcpVssInfo, Dns, DnsName, DnsQuestion, DnsRecord, DnsRecordData, Dot1Q,
    EdnsOption, Ethernet, Icmp, IcmpExtension, IcmpExtensionMpls, IcmpExtensionObject, IcmpKind,
    IcmpLayer, Icmpv6, IpProtocol, Ipv4, Ipv4Option, Ipv4OptionIter, Ipv4RouteOptionKind, Ipv6,
    Ipv6FragmentHeader, Ipv6MobileRoutingHeader, Ipv6RoutingHeader, Ipv6SegmentRoutingHeader,
    LinuxSll, NullByteOrder, NullLoopback, OptionOverload, SipServers, Tcp, TcpExtendedDataOffset,
    TcpOption, TcpOptionIter, TcpSackBlock, Udp, UdpChecksumStatus, UdpOption, UdpOptionIter,
    UdpOptionKindClass, UdpOptionStatus, UdpOptions, Vlan, ARP_HRD_ATM, ARP_HRD_ETHERNET,
    ...
    DNS_RCODE_SERVFAIL, DNS_RCODE_YXDOMAIN, DNS_RCODE_YXRRSET, DNS_TYPE_A, DNS_TYPE_AAAA,
    DNS_TYPE_CNAME, DNS_TYPE_DNSKEY, DNS_TYPE_DS, DNS_TYPE_HTTPS, DNS_TYPE_MX, DNS_TYPE_NS,
    DNS_TYPE_NSEC, DNS_TYPE_NSEC3, DNS_TYPE_NSEC3PARAM, DNS_TYPE_OPT, DNS_TYPE_PTR, DNS_TYPE_RRSIG,
...
pub mod core {
    ...
    pub use crate::{
        ...
        option_name, option_status, scan_dhcp_option_segments, typed_option_value,
        ...
        DnsRecord, DnsRecordData, Dot1Q, EdnsOption, Ethernet, EthertypeBindingContext, Field,
        ...
        DNS_RCODE_YXDOMAIN, DNS_RCODE_YXRRSET, DNS_TYPE_A, DNS_TYPE_AAAA, DNS_TYPE_CNAME,
