...
pub use protocols::{
    ...
    Ipv4Protocol, Ipv4RouteOptionKind, Ipv6, Ipv6FragmentHeader, Ipv6MobileRoutingHeader,
    Ipv6RoutingHeader, Ipv6SegmentRoutingHeader, LinuxSll, Mldv2Query, Mldv2Report,
    ...
    IPPROTO_IPV6_HOPOPTS, IPPROTO_IPV6_ROUTE, IPPROTO_OSPF, IPPROTO_SCTP, IPPROTO_TCP, IPPROTO_UDP,
    ...
    IPV4_OPTION_TIMESTAMP, IPV4_OPTION_TRACEROUTE, IPV6_ROUTING_TYPE_MOBILE,
...
pub mod core {
    ...
    pub use crate::{
        ...
        IPPROTO_IPV6_ROUTE, IPPROTO_OSPF, IPPROTO_SCTP, IPPROTO_TCP, IPPROTO_UDP,
        IPV4_FLAG_DONT_FRAGMENT, IPV4_FLAG_MORE_FRAGMENTS, IPV4_FLAG_RESERVED, IPV4_OPTION_EOL,
        IPV4_OPTION_EXPERIMENTAL_1, IPV4_OPTION_EXPERIMENTAL_2, IPV4_OPTION_EXPERIMENTAL_3,
        IPV4_OPTION_EXPERIMENTAL_4, IPV4_OPTION_LOOSE_SOURCE_ROUTE, IPV4_OPTION_NOP,
        IPV4_OPTION_RECORD_ROUTE, IPV4_OPTION_ROUTER_ALERT, IPV4_OPTION_STRICT_SOURCE_ROUTE,
