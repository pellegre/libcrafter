...
pub use protocols::{
    ...
    decode_tftp_server_addresses, dns_type_name, edns_option_code_name,
    ...
    Dscp, Eapol, Ecn, EdnsOption, Ethernet, IcmpExtension, IcmpExtensionInterfaceId,
...
pub mod core {
    ...
    pub use crate::{
        arp_hardware_type_label, arp_protocol_type_label, decode_dns_name, decode_dns_name_typed,
        decode_tftp_server_addresses, dns_type_name, edns_option_code_name, hexdump,
        ipv6_fragment_header_status_label, ipv6_router_alert_value_label, ipv6_routing_type_label,
        ipv6_routing_type_status, ndp_option_type_is_known, ndp_option_type_name,
        ndp_rdnss_length_units, option_meta, option_name, option_status, scan_dhcp_option_segments,
        svcb_param_key_name, tcp_option_kind_class, tcp_option_kind_is_assigned,
        ...
        Dot1Q, Dscp, Eapol, Ecn, EdnsOption, Ethernet, EthertypeBindingContext, Field, FieldState,
