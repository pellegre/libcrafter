...
pub use protocols::{
    ...
    DnsTypeBitmaps, Dot1Q, EdnsOption, Ethernet, Icmp, IcmpExtension, IcmpExtensionMpls,
    ...
    Tcp, TcpExtendedDataOffset, TcpOption, TcpOptionIter, TcpSackBlock, Udp, UdpChecksumStatus,
...
pub mod core {
    ...
    pub use crate::{
        ...
        EthertypeBindingContext, Field, FieldState, Icmp, IcmpExtension, IcmpExtensionMpls,
        IcmpExtensionObject, IcmpKind, IcmpLayer, Icmpv6, IntoPacket, IpProtocol, Ipv4, Ipv4Option,
        Ipv4OptionIter, Ipv4ProtocolBindingContext, Ipv4RouteOptionKind, Ipv6, Ipv6FragmentHeader,
