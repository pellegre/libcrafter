...
pub use protocols::{
    ...
    typed_option_value, Arp, ArpOperation, Dhcp, DhcpMalformed, DhcpMessageType, DhcpOption,
    ...
    DnsRecordData, Dot1Q, Ethernet, Icmp, IcmpExtension, IcmpExtensionMpls, IcmpExtensionObject,
    IcmpKind, IcmpLayer, Icmpv6, IpProtocol, Ipv4, Ipv4Option, Ipv4OptionIter, Ipv4RouteOptionKind,
    Ipv6, Ipv6FragmentHeader, Ipv6MobileRoutingHeader, Ipv6RoutingHeader, Ipv6SegmentRoutingHeader,
    LinuxSll, NullByteOrder, NullLoopback, OptionOverload, Tcp, TcpExtendedDataOffset, TcpOption,
    TcpOptionIter, TcpSackBlock, Udp, Vlan, BOOTP_REPLY, BOOTP_REQUEST, DHCP_ACK, DHCP_CLIENT_PORT,
    ...
    DNS_CLASS_IN, DNS_FLAG_AUTHENTIC_DATA, DNS_FLAG_AUTHORITATIVE, DNS_FLAG_CHECKING_DISABLED,
...
pub mod core {
    ...
    pub use crate::{
        ...
        CrafterError, Dhcp, DhcpMalformed, DhcpMessageType, DhcpOption, DhcpOptionArea,
        DhcpOptionCode, DhcpOptionFormat, DhcpOptionKind, DhcpOptionMeta, DhcpOptionSegment,
        DhcpOptionStatus, DhcpOptionValue, Dns, DnsQuestion, DnsRecord, DnsRecordData, Dot1Q,
