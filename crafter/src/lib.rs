...
pub use protocols::{
    ...
    TcpSackBlock, Udp, UdpChecksumStatus, UdpOptionStatus, Vlan, ARP_HRD_ATM, ARP_HRD_ETHERNET,
...
pub mod core {
    ...
    pub use crate::{
        ...
        Udp, UdpBindingContext, UdpChecksumStatus, UdpOptionStatus, Vlan, ARP_HRD_ATM,
