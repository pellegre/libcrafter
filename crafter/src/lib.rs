...
pub use protocols::{
    ...
    TcpSackBlock, Udp, UdpChecksumStatus, UdpOptionStatus, UdpOptions, Vlan, ARP_HRD_ATM,
    ...
    TCP_OPTION_WINDOW_SCALE, UDP_HEADER_LEN, UDP_OPTION_APC, UDP_OPTION_AUTH, UDP_OPTION_EOL,
    UDP_OPTION_EXP, UDP_OPTION_FRAG, UDP_OPTION_MDS, UDP_OPTION_MRDS, UDP_OPTION_NOP,
    UDP_OPTION_REQ, UDP_OPTION_RES, UDP_OPTION_RESERVED_SAFE_END, UDP_OPTION_RESERVED_SAFE_START,
...
pub mod core {
    ...
    pub use crate::{
        arp_hardware_type_label, arp_protocol_type_label, decode_dns_name,
        decode_tftp_server_addresses, hexdump, option_meta, option_name, option_status,
        scan_dhcp_option_segments, typed_option_value, Arp, ArpOperation,
        ...
        Udp, UdpBindingContext, UdpChecksumStatus, UdpOptionStatus, UdpOptions, Vlan, ARP_HRD_ATM,
        ARP_HRD_ETHERNET, ARP_HRD_FIBRE_CHANNEL, ARP_HRD_IEEE_802, ARP_HRD_INFINIBAND,
