...
pub use wire::{
    ...
    WifiProtectionStatus, WireError, WpaAkm, WpaCipher, WpaDecrypt, WpaDecryptConfig,
    WpaDecryptReason, WpaHandshakeStatus, WpaKeyKind, WpaMetadata, WpaNetwork, WriteReport,
};
