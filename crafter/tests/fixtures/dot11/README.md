...
`02:00:5e:10:*:*`. The beacon SSID strings `crafter` and `rsn-fixture` are
synthetic fixture markers, not network names. IP payloads use documentation
address space. EAPOL-Key fixtures exercise typed phase 1.5 parsing; other
unsupported EAPOL and RSN bytes remain raw-preserved until their later plan
steps.
