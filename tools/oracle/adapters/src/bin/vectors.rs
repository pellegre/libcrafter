...
fn normalize_field_name(layer: &str, field: &str) -> String {
    let layer_name = match (layer, field) {
        ...
        ("dhcpv4", "ciaddr") => "client_ip",
        ("dhcpv4", "chaddr") => "client_hardware_address",
        ("dhcpv4", "giaddr") => "relay_ip",
        ("dhcpv4", "htype") => "hardware_type",
        ("dhcpv4", "hlen") => "hardware_length",
        ("dhcpv4", "siaddr") => "server_ip",
        ("dhcpv4", "xid") => "transaction_id",
        ("dhcpv4", "yiaddr") => "your_ip",
