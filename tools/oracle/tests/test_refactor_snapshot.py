...
# Trigger support intentionally adds a subtype domain value and a case to both
# the dot11 stack and feature. This changes weighted case selection even for
# broad profiles that sample Wi-Fi alongside other protocols. Restoring those
# three grammar entries to their pre-Trigger state reproduces all old digests.
EXPECTED_DIGESTS = {
    ...
    "dot11-pcap": "6afb16cd4ac12e5e28b8d5be48c3cbc44e8a98550712c71cc9e69259400d763c",
    "dot11-smoke": "11300500eb2a93252ed76758d31d50663970172ab3702bd9585d7f6302af9d34",
    "eapol-smoke": "08a5cca0a58853274415bd15a69e783c9e52047fc3cbb46498976870f81f30a4",
    ...
    "igmp-smoke": "bf176584aed10ad08aab67e7a4df6550a7df3d781486acfd53e8d5ed60b929a2",
    ...
    "mdns-ci": "500961a16398f15a5ce6405d5158c79459b051b3143091a22618b32760de3090",
    "mdns-pcap": "79b97c6cde56c4733ca61587dd586d587b684638e049814e6539f17bc5723204",
    ...
    "radiotap-smoke": "8f040cce6fab99465c0f323a6937ee5645794447f1ec7e0263d8e365fa369858",
    "rip-smoke": "5dfd7ad4bc2428075418fa0de787a1df377c09d8223f6892a80cb964cbdec092",
    "rsn-smoke": "078cd1acca7458d143647761f77aeb933b0de0ddba6b4ee707fe6c4e308d7b32",
    ...
    "ssdp-pcap": "1619d5bf40f0e98e5c2b84ad0ee3d890473143b79319f842d997cee5e7d001fb",
    "ssdp-smoke": "e798fa4d1f20b364f3db89569a9d5661c42ffc62d6b12ef880355679716e81ae",
