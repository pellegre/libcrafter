...
FEATURE_DIRECTIONS = (*ONE_WAY_DIRECTIONS, ROUNDTRIP, LIVE, LIVE_EXCHANGE)
OFFLINE_DIRECTIONS = ONE_WAY_DIRECTIONS
PCAP_DIRECTIONS = (*ONE_WAY_DIRECTIONS, ROUNDTRIP)
LIVE_PHASE_DIRECTIONS = (LIBCRAFTER_TO_BACKEND, BACKEND_TO_LIBCRAFTER)
LIVE_REQUEST_DIRECTIONS = (*LIVE_PHASE_DIRECTIONS, LIVE_EXCHANGE)
