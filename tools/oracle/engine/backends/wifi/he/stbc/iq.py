...
from tools.oracle.engine.backends.wifi.he.bcc.iq import PILOTS, TONES
from tools.oracle.engine.backends.wifi.he.dcm.iq import payload
...
def waveform(mcs, size, guard, ldpc, padding, case, period=None, invalid=None, er=False, upper106=False,damaged_codeword=None,aggregate=None,bss_color=0,return_complex=False):
    ...
    extra=0
    if ldpc:
        from tools.oracle.engine.backends.wifi.he.ldpc.rate import layout,encode_information
        ...
        if damaged_codeword is not None:
            from tools.oracle.engine.backends.wifi.he.ldpc.rate import damage_codeword
    ...
    if er:
        from tools.oracle.engine.backends.wifi.he.er.prefix import prefix_wave
