...
from tools.oracle.engine.backends.wifi.he.tb.ldpc.layout import layout
from tools.oracle.engine.backends.wifi.he.ldpc.rate import encode_information, damage_codeword
...
if __name__ == "__main__":
    ...
    path = IQ_FIXTURES / "he-tb-ldpc-payload.tsv"
    content = generate()
    if args.write:
