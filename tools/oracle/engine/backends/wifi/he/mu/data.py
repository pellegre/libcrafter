...
from tools.oracle.engine.backends.wifi.he.ldpc.rate import layout, encode_information, damage_codeword, RATES
...
def waveform(code,mcs,ldpc,dcm,size,guard,impaired=False,nltf=1,period=0,damage='none',mac_payloads=None,
    ...
    if tb_ru is not None:
        from tools.oracle.engine.backends.wifi.he.tb.signal import header as tb_header
