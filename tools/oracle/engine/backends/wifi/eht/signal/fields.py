...
from tools.oracle.engine.backends.wifi.ldpc.codeword import FIXTURE as LDPC_FIXTURE, encode as ldpc_encode
import tools.oracle.engine.backends.wifi.ofdm.base as base


OUT = IQ_FIXTURES / "eht-sig-index.tsv"
MU_OUT = IQ_FIXTURES / "eht-mu-sig-index.tsv"
OFDMA_OUT = IQ_FIXTURES / "eht-ofdma-sig-index.tsv"
DATA_TIMING_OUT = IQ_FIXTURES / "eht-data-timing-index.tsv"
DATA_CAPACITY_OUT = IQ_FIXTURES / "eht-data-capacity-index.tsv"
DATA_BCC_OUT = IQ_FIXTURES / "eht-data-bcc-index.tsv"
DATA_LDPC_OUT = IQ_FIXTURES / "eht-data-ldpc-index.tsv"
DATA_LDPC_PAYLOAD_OUT = IQ_FIXTURES / "eht-data-ldpc-payload-index.tsv"
