...
from tools.endpoint.engine.providers import hetzner, qemu, resolve_provider, virtualbox
from tools.endpoint.engine.registry import (
...
def _manifest(root: Path) -> EndpointManifest:
    return EndpointManifest(
        ...
        provider_resources=ProviderResources(metadata={"created_by": "tools/endpoint-test"}),
