...
from tools.endpoint.engine.providers.hetzner import network as hetzner_network
from tools.endpoint.engine.state import read_endpoint_manifest, read_private_group_record
...
class HetznerPrivateNetworkSubnetTest(unittest.TestCase):
    ...
    def test_add_subnet_called_without_output_flag(self) -> None:
        from tools.endpoint.engine.providers.hetzner.network import _ensure_private_network
