...
WIRE_STATE_ROOT_ENV = "LIBCRAFTER_WIRE_STATE_ROOT"
WIRE_ARTIFACT_ROOT_ENV = "LIBCRAFTER_WIRE_ARTIFACT_ROOT"
WIRE_STATE_DIR_ENV = "LIBCRAFTER_WIRE_STATE_DIR"
WIRE_ARTIFACT_DIR_ENV = "LIBCRAFTER_WIRE_ARTIFACT_DIR"
