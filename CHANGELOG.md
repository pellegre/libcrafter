...
- MQTT coverage for cleartext MQTT 3.1.1 and 5.0 over TCP/1883, including
  ...
  helpers, stacked TCP-payload decode, the `mqtt_session` dry-run example,
  reference backend oracle cross-validation, CI corpus/pcap parity, and a
  dry-run-default `mqtt-smoke` probe/lab path.
